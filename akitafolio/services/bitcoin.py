...
def convert_xpub(xpub: str, target_prefix: str) -> Optional[str]:
    ...
    try:
        ...
        if checksum != expected_checksum:
            logger.warning(f"Invalid xpub checksum")
            return None
...
def derive_addresses_from_xpub(xpub: str, address_type: str = 'p2wpkh_in_p2sh', count: int = 20) -> List[str]:
    """
...
class BitcoinService:
    ...
    async def get_xpub_balance(cls, xpub: str) -> Dict:
        ...
        try:
            ...
            logger.info(f"Trying format conversions...")

...
from akitafolio.models import PortfolioSnapshot, UserAddresses
...
DEFAULT_USER_DATA = {"eth": [], "btc": [], "xpub": [], "tokens": [], "track_defi": True}
...
def save_portfolio_snapshot(
    ...
    try:
        ...
        user_history = [
            s for s in user_history if datetime.fromisoformat(s["timestamp"]) > cutoff_date
        ]
